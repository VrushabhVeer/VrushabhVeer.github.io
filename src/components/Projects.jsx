      ...
      <SimpleGrid columns={[1, 1, 2, 2, 3]} spacing="38px" mt="8">
        ...
        >
          ...
          <Box p="5">
            ...
            <Text mt="3" fontSize={{ base: "14px", md: "15px" }}>
            ...
            >
              ...
              <Link href="https://adidas-shopping.vercel.app/" target="_blank">
        ...
        >
          ...
          <Box p="5">
            ...
            >
              ...
              <Link href="https://readit-blogs.vercel.app" target="_blank">
                <i className="fa-solid fa-eye"></i>
              </Link>
            </Flex>
          </Box>
        ...
        >
          ...
          <Box p="5">
            ...
            <Text mt="3" fontSize={{ base: "14px", md: "15px" }}>
              Coinvest is a cryptocurrency trading app, where you can buy or
              sell the cryptocurrencies, you can see the current market value,
              prizes & stats of the coin live & buy or sell according to stats.
            </Text>
            <Flex
              mt="5"
              alignItems="center"
            ...
            >
              <Link
                href="https://github.com/VrushabhVeer/coinvest"
                target="_blank"
              >
                <i className="fa-brands fa-github"></i>
              </Link>
              ...
              <Link
                href="https://coinvest-crypto-trading.vercel.app/"
                target="_blank"
              >
                <i className="fa-solid fa-eye"></i>
              </Link>
